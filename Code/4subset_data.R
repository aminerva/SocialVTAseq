...
# hungry_neurons <- subset(all_neurons, subset = condition == "hungry")
# sated_neurons <- subset(all_neurons, subset = condition == "sated")
...
# saveRDS(hungry_neurons, file="../../../seurat_objects/hungry_all_neurons.RDS")
# saveRDS(sated_neurons, file="../../../seurat_objects/sated_all_neurons.RDS")
...
# hungry_da <- subset(hungry_neurons, subset = Slc6a3 > 0 | Th > 0 ) 
# hungry_gaba <- subset(hungry_neurons, subset = Slc32a1>0 & Slc6a3==0 & Th==0 & Slc17a6==0 & Slc17a7==0 & Slc17a8==0 | Gad1>0 & Slc6a3==0 & Th==0 & Slc17a6==0 & Slc17a7==0 & Slc17a8==0 | Gad2>0 & Slc6a3==0 & Th==0 & Slc17a6==0 & Slc17a7==0 & Slc17a8==0)
# hungry_glut <- subset(hungry_neurons, subset = Slc17a6>0 & Slc6a3==0 & Th==0 & Slc32a1==0 & Gad1==0 & Gad2==0 | Slc17a7>0 & Slc6a3==0 & Th==0 & Slc32a1==0 & Gad1==0 & Gad2==0 | Slc17a8>0 & Slc6a3==0 & Th==0 & Slc32a1==0 & Gad1==0 & Gad2==0) 
# sated_da <- subset(sated_neurons, subset = Slc6a3 > 0 | Th > 0 ) 
# sated_gaba <- subset(sated_neurons, subset = Slc32a1>0 & Slc6a3==0 & Th==0 & Slc17a6==0 & Slc17a7==0 & Slc17a8==0 | Gad1>0 & Slc6a3==0 & Th==0 & Slc17a6==0 & Slc17a7==0 & Slc17a8==0 | Gad2>0 & Slc6a3==0 & Th==0 & Slc17a6==0 & Slc17a7==0 & Slc17a8==0)
# sated_glut <- subset(sated_neurons, subset = Slc17a6>0 & Slc6a3==0 & Th==0 & Slc32a1==0 & Gad1==0 & Gad2==0 | Slc17a7>0 & Slc6a3==0 & Th==0 & Slc32a1==0 & Gad1==0 & Gad2==0 | Slc17a8>0 & Slc6a3==0 & Th==0 & Slc32a1==0 & Gad1==0 & Gad2==0) 
...
# hungry_da[["nucleusID"]] <- colnames(hungry_da)
# hungry_gaba[["nucleusID"]] <- colnames(hungry_gaba)
# hungry_glut[["nucleusID"]] <- colnames(hungry_glut)
# sated_da[["nucleusID"]] <- colnames(sated_da)
# sated_gaba[["nucleusID"]] <- colnames(sated_gaba)
# sated_glut[["nucleusID"]] <- colnames(sated_glut)
...
# saveRDS(hungry_da, file="../../../seurat_objects/hungry_da.RDS") 
# saveRDS(hungry_gaba, file="../../../seurat_objects/hungry_gaba.RDS") 
# saveRDS(hungry_glut, file="../../../seurat_objects/hungry_glut.RDS") 
# saveRDS(sated_da, file="../../../seurat_objects/sated_da.RDS") 
# saveRDS(sated_gaba, file="../../../seurat_objects/sated_gaba.RDS") 
# saveRDS(sated_glut, file="../../../seurat_objects/sated_glut.RDS") 
